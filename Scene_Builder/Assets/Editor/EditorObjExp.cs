...
public class EditorObjExporter : ScriptableObject
{
    ...
    private static string targetFolder = @"C:\Users\leogiuris\Documents\_optScan_v3_jun2019\testeLeonardo";
    ...
    static void ExportSelectionToSeparate()
    {
        ...
        {
            EditorUtility.DisplayDialog("No source object selected!", "Please select one or more target objects", "jae");
            return;
        }
    ...
    static void ExportWholeSelectionToSingle()
    {
        ...
        if (exportedObjects > 0)
        {
            ...
            EditorUtility.DisplayDialog("Objects exported", "Exported " + exportedObjects + " objects to " + filename, "jooj");
        }
        else
            EditorUtility.DisplayDialog("Objects not exported", "Make sure at least some of your selected objects have mesh filters!", "");
    }
    ...
    static void ExportEachSelectionToSingle()
    {
        ...
        if (exportedObjects > 0)
        {
            EditorUtility.DisplayDialog("Objects exported", "Exported " + exportedObjects + " objects", "jooj");
        }
        else
            EditorUtility.DisplayDialog("Objects not exported", "Make sure at least some of your selected objects have mesh filters!", "jae");
    }
